...
c
c     num_procs  - total number of processes
c     num_procs2 - power-of-two value, no less than num_procs
c     num_zprocs - number of processes assigned to zone dimension
